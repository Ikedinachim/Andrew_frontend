...
const ModuleDetailsPage = () => {
    return (
        <div>
            ...
            <div className='w-[318px] h-[80px] shadow-md rounded-xl relative flex flex-row items-center'>
                <div className='w-[106px] h-[106px] rounded-[100%] left-5 absolute bg-[#D9D9D9] flex items-center justify-center' >
                <svg className="w-106 h-106" viewBox="0 0 64 64">
                            <circle
            ...
            <div>
                <div className="w-full max-w-sm p-4 bg-white rounded-lg shadow-md flex items-center space-x-4">

  ...
  const steps: Step[] = [
    {
        ...
        subtitle: "Select One",
        items: [
          { title: 'Student', imgSrc: '/assets/Student.png', imgAlt: 'Icon representing student' },
          { title: 'Professional', imgSrc: '/assets/Professional 1.png', imgAlt: 'Icon representing professional' },
          { title: 'Lifelong Learner', imgSrc: '/assets/Lifelong leraner 1.png', imgAlt: 'Icon representing Lifelong learner' },
        ],
        allowMultiple: false,
      },
    {
      ...
      items: [
        { title: 'Prepare for exams', imgSrc: '/assets/Exam 1.png', imgAlt: 'Icon representing exam preparation' },
        { title: 'Learn new skills', imgSrc: '/assets/skills 1.png', imgAlt: 'Icon representing learning new skills' },
        { title: 'Improve knowledge in a specific field', imgSrc: '/assets/Improve Knowledge 1.png', imgAlt: 'Icon representing improving knowledge in a specific field' },
        { title: 'Get certified / career advancement', imgSrc: '/assets/Certified 1.png', imgAlt: 'Icon representing getting certified or career advancement' },
      ],
      allowMultiple: true,
    },
    {
      ...
      subtitle: "Select One",
      items: [
        { title: 'Less than 3 hours', imgSrc: '/assets/Less than 3 hours 1.png', imgAlt: 'Icon representing sad face' },
        { title: '3 - 5 hours', imgSrc: '/assets/3-5 Hrs 1.png', imgAlt: 'Icon representing normal face' },
        { title: '5 - 10 hours', imgSrc: '/assets/5-10 hrs 1.png', imgAlt: 'Icon representing smiling face' },
        { title: 'More than 10 hours', imgSrc: '/assets/More than 10 hr 1.png', imgAlt: 'Icon representing joyful face' },
      ],
      allowMultiple: false,
    },
    {
        ...
        subtitle: "Select One",
        items: [
          { title: 'Yes', imgSrc: '/assets/Yes 1.png', imgAlt: 'Icon representing alarm ringing' },
          { title: 'No', imgSrc: '/assets/No.png', imgAlt: 'Icon representing alarm not ringing' },
        ],
        allowMultiple: false,
      },
  ];

...
const QuizCardList = (props) => {
    ...
    return (
        <div className="bg-white p-7 rounded-2xl shadow-md mb-6 relative mr-6">
            <h2 className="text-lg font-semibold text-[#333333] mb-2">{props.quiz.title}</h2>
            ...
            <p className='font-semibold my-3'>Grade: {moduleDetailData.data.courseGrade ? moduleDetailData.data.courseGrade + "%" : ''} </p>

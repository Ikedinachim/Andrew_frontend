    ...
    return (
        <div className="bg-white p-7 rounded-2xl shadow-md mb-6 relative mr-6">
            ...
            <div className="flex items-center mb-4">
                ...
                <span className="text-[#AAAAAA] text-sm">  5 Quizzes </span>
            </div>
            <p className='font-semibold my-3'>Grade: 65(B-) </p>
            <div className='flex flex-row'>
                <button className="bg-[#040bc5] border-2 border-[#040bc5] text-white text-base px-4 py-2 rounded-lg mr-3 hover:shadow-lg hover:bg-[#585CD8] hover:border-[#585CD8] cursor-pointer">Retake Quiz</button>

                <button className="border-2 border-[#040BC5] text-[#040BC5] px-4 py-2 rounded-lg mr-2 hover:shadow-xl cursor-pointer" onClick={() => viewInsightHandler()}>View Quiz Report</button>
            </div>

    ...
    <div className="bg-white p-7 rounded-3xl shadow-lg mb-6 flex flex-row justify-between items-start flex-wrap">
      <div className="max-w-full md:max-w-[80%]">
        ...
        <div className="flex items-center mt-4 flex-wrap">
          <button onClick={() => handleResumeCourse()} className="bg-[#040BC5] text-white px-5 py-2 rounded-md mr-2 mb-2 hover:shadow-xl hover:bg-[#CDCEF3] hover:text-[#040BC5] cursor-pointer">
            Resume Course
          </button>

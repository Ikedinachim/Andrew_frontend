  ...
  return (
    <div>
      <div className="flex flex-row max-w-[243px] max-h-[80px] items-center justify-start mb-[60px] mt-[19px]">
        {/* <img src="../../public/assets/bi_filter.svg" alt="" onClick={() => props.toggleDrawer()} /> */}
        <div><img src="./public/assets/logo.svg" alt="Andrew AI"/></div>
      </div>
      ...
      >
        <img src="../../public/assets/Dashboard.svg" alt="" className="mr-[16px]" />
        <p>Dashboard</p>
      </NavLink>
      ...
      <NavLink to={'/dashboard/view-courses'} className={({ isActive }) =>
        ...
        <img src="../../public/assets/Vector.svg" alt="" className="mr-[16px]" />
        <p>Courses</p>
      </NavLink>
      <NavLink to={'/dashboard/view-modules'} className={({ isActive }) =>
        ...
        <img src="../../public/assets/Quiz.svg" alt="" className="mr-[16px]" />
        <p>Modules/Quizzes</p>
      </NavLink>
      <NavLink to={'/dashboard/performance-report'} className={({ isActive }) =>
        ...
        <img src="../../public/assets/Performance Reports.svg" alt="" className="mr-[16px]" /> 
      ...
      {/* <NavLink to={'/dashboard/recommendations'} className={({ isActive }) =>
        ...
        <img src="../../public/assets/Recommendation.svg" alt="" className="mr-[16px]" />
        <p>Recommendations</p>
      </NavLink> */}
    </div>
